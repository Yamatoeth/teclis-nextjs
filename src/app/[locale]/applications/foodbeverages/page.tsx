...
export async function generateMetadata({params}) {
  ...
  const alternates: { hrefLang: string; href: string }[] = otherLocales.map(l => ({
    hrefLang: l,
    href: `${baseUrl}/${l}/applications/foodbeverages`,
  }));
 
  return {
    title: t('foodBeverages.title'),
    description: t('foodBeverages.description'),
    alternates: {
      canonical: `${baseUrl}/${locale}/applications/foodbeverages`,
